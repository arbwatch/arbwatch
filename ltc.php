...
<div class="container">
    ...
    <div class="row">
        ...
        $btc_fee_total = (374 * $btc_fee->fastestFee) / 100000000; // in satoshis
        // https://estimatefee.com/
        
        $transfered_btc = $order_buy_btcbrl - $btc_fee_total;
...
$(function() {
    $('.arb-header').on('click',function(){
        if ($(this).hasClass('with-details')) {
            $(this).parent().find('.detail').hide();
            $(this).removeClass('with-details');   
        } else {
